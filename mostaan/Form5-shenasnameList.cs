...
namespace mostaan
{
    public partial class Form5_shenasnameList : Form
    {
        ...
        public Form5_shenasnameList()
        {
            ...
            var q = dbcontext.shenasnames.Where(x => x.final == 0).OrderByDescending(x=>x.ID);// && x.isDone != true
            if (q != null)
            {
                lst = q.ToList();
            }
            ...
            for (int i = 0; i< lst.Count; i = i+2)
            {
                ...
                if (lst.Count() > i)
                {
                    ...
                    Telerik.WinControls.UI.RadPanel radPanel293 = new Telerik.WinControls.UI.RadPanel();
                    radPanel293.Dock = System.Windows.Forms.DockStyle.None;
                    radPanel293.Padding = new System.Windows.Forms.Padding(5);
                    radPanel293.Height = 50;
                    radPanel293.Width = radPanel29.Width / 2;
                    radPanel293.PanelElement.Shape = new RoundRectShape();
                    radPanel293.PanelElement.PanelFill.GradientStyle = GradientStyles.Solid;
                    radPanel293.PanelElement.PanelFill.BackColor = Color.Red;
                    ((Telerik.WinControls.Primitives.BorderPrimitive)(radPanel293.GetChildAt(0).GetChildAt(1))).Visibility = Telerik.WinControls.ElementVisibility.Collapsed;

                    System.Windows.Forms.Label lable293 = new System.Windows.Forms.Label();
                    lable293.BackColor = System.Drawing.Color.Transparent;
                    lable293.Dock = System.Windows.Forms.DockStyle.Fill;
                    lable293.ForeColor = System.Drawing.Color.White;
                    lable293.Location = new System.Drawing.Point(5, 5);
                    lable293.TabIndex = 0;
                    lable293.Text = "نسخه جدید";
                    lable293.Name = "N" + lst[i].ID.ToString();
                    lable293.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
                    lable293.AutoSize = false;
                    lable293.Font = GlobalVariable.headerlistFONTsupecSmall;
                    lable293.Click += new System.EventHandler(DeleteItem);
                ...
                if (lst.Count() >  i+1)
                {
                    ...
                    lable38.TabIndex = 0;
                    lable38.Text = lst[i + 1].date.ToPersianDateString();
                    ...
                    Telerik.WinControls.UI.RadPanel radPanel393 = new Telerik.WinControls.UI.RadPanel();
                    radPanel393.Dock = System.Windows.Forms.DockStyle.Right;
                    radPanel393.Padding = new System.Windows.Forms.Padding(5);
                    radPanel393.Height = 50;
                    radPanel393.Width = radPanel39.Width / 2;
                    radPanel393.PanelElement.Shape = new RoundRectShape();
                    radPanel393.PanelElement.PanelFill.GradientStyle = GradientStyles.Solid;
                    radPanel393.PanelElement.PanelFill.BackColor = Color.Red;
                    ((Telerik.WinControls.Primitives.BorderPrimitive)(radPanel393.GetChildAt(0).GetChildAt(1))).Visibility = Telerik.WinControls.ElementVisibility.Collapsed;

                    System.Windows.Forms.Label lable393 = new System.Windows.Forms.Label();
                    lable393.BackColor = System.Drawing.Color.Transparent;
                    lable393.Dock = System.Windows.Forms.DockStyle.Fill;
                    lable393.ForeColor = System.Drawing.Color.White;
                    lable393.Location = new System.Drawing.Point(5, 5);
                    lable393.TabIndex = 0;
                    lable393.Text = "نسخه جدید";
                    lable393.Name = "N" + lst[i].ID.ToString();
                    lable393.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
                    lable393.AutoSize = false;
                    lable393.Font = GlobalVariable.headerlistFONTsupecSmall;
        ...
        private void DeleteItem(object sender, EventArgs e)
        {
            ...
            shenasname delitem = dbcontext.shenasnames.SingleOrDefault(x => x.ID == GlobalVariable.shenasnameID);
             dbcontext.shenasnames.Remove(delitem);
