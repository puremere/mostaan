...
namespace mostaan
{
    public partial class Form11_addMasrafi : Form
    {
        ...
        public Form11_addMasrafi()
        {
            ...
            radPanel5.PanelElement.PanelFill.BackColor = Color.Violet;
            ...
            using (var dbcontext = new Model.Context()) {
                List<Model.masrafi> lst = (from p in dbcontext.masrafis where p.shenasnameID == shenasnameID select p).ToList();
