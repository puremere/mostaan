...
namespace mostaan
{
    public partial class Form13_Hazine_edari : Form
    {
        ...
        public Form13_Hazine_edari()
        {
            ...
            {
                List<Model.edari> lst = (from p in dbcontext.edaris where p.shenasnameID == shenasnameID select p).ToList();
            ...
            dataGridView1.Columns["kollND"].DisplayIndex = 6;
        ...
        {
            Form11_addMasrafi form15 = new Form11_addMasrafi();
            form15.Show();
            this.Hide();
        }
