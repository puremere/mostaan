...
namespace mostaan
{
    public partial class Bakhsh_List : Form
    {
        ...
        public Bakhsh_List()
        {
            ...
            haderPanelLable.Text = "لیست بخش ها ";
        ...
        private void showCopies(object sender, EventArgs e)
        {
            ...
            string id = element.Name.Substring(1, element.Name.Length - 1);
            GlobalVariable.bakhshID = id;
            Bakhsh_ShoCopies form = new Bakhsh_ShoCopies();
            form.Show();
        }
