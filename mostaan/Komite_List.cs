...
namespace mostaan
{
    public partial class Komite_List : Form
    {
        ...
        public Komite_List()
        {
            ...
            List<Model.komite> lst = new List<komite>();
            ...
            haderPanelLable.Text = "لیست کمیته ها  ";
        ...
        private void showCopies(object sender, EventArgs e)
        {
            var element = sender as Label;
            string id = element.Name.Substring(1, element.Name.Length - 1);
            GlobalVariable.comiteID = id;
            Komite_ShoCopies form = new Komite_ShoCopies();
            form.Show();
        }
