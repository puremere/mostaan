...
namespace mostaan
{
    public partial class Form17_gharadad : Form
    {
        ...
        public Form17_gharadad()
        {
            ...
            radPanel9.PanelElement.PanelFill.BackColor = Color.Violet;
            ...
            {
                List<Model.gharardad> lst = (from p in dbcontext.gharardads where p.shenasnameID == shenasnameID select p).ToList();
            ...
            dataGridView1.Columns["level"].HeaderText = "مرحله هزینه";
            dataGridView1.Columns["level"].Width = 216;
            dataGridView1.Columns["level"].DisplayIndex = 3;
